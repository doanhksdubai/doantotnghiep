...
function Booking() {
    ...
    const handleSubmit = async (e) => {
        ...
        // Nếu có discountedPrice (đã trừ mã giảm giá), thì trừ thêm childrenDiscount
        const finalAmount = parseFloat(formData.discountedPrice) || (totalAmount - childrenDiscount);
